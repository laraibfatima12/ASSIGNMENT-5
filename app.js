...
//if(num_1>num_2){
//document.write("the subraction of" , num_1 num _2 , "is", num_1- num_2 + "<br>");
//}
//else{
//document.write("the subraction of ", num_1 ,"and" , num_2, "is -" , num_2 -num_1 +"<br>")
//}
...
//--value;
//document.write("value the decrement is:",value, "<br>")
//value = value%3;
...
//  document.write ("total cost is is: ", (price_1*quantity_1) + (price_2*quantity_2) + shipping_charges, "<br>");
...
// for (let i=1;i<=loop_value;i++)  {  value = value+snack_per_day;}
